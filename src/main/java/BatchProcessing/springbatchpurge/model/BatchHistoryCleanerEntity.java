...
@AllArgsConstructor
@Getter
public enum BatchHistoryCleanerEntity {
    ...
    BATCH_JOB_EXECUTION("DELETE FROM BATCH_JOB_EXECUTION WHERE JOB_INSTANCE_ID = ?"),
    BATCH_JOB_INSTANCE("DELETE FROM BATCH_JOB_INSTANCE WHERE JOB_INSTANCE_ID = ?");
